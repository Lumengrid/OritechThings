...
public class ConfigLoader {
    ...
    public List<AddonInfo> addonSettings = new ArrayList<>(
        List.of(
            new AddonInfo(0.79f, 1.10f,0.86f, 4_000_000, 2_000, 1_000_000, 4000, 2f, 2 ),
            new AddonInfo(0.7f, 1.15f, 0.81f, 6_000_000, 3_000, 1_500_000, 6000 , 2.5f, 3 ),
            new AddonInfo(0.6f, 1.22f, 0.725f, 8_000_000, 4_000, 2_000_000, 8000 , 3f, 4 ),
            new AddonInfo(0.5f, 1.36f, 0.62f,  10_000_000, 5_000, 2_500_000, 10000 , 3.5f, 5 ),
            new AddonInfo(0.4f, 1.60f, 0.47f, 12_000_000, 6_000, 3_000_000, 12000 , 4f, 6 ),
            new AddonInfo(0.3f, 2.10f,0.30f,  14_000_000, 7_000, 3_500_000, 14000 , 4.5f, 7 ),
            new AddonInfo(0.2f, 3.30f, 0.153f, 16_000_000, 8_000, 4_000_000, 14000 , 5f, 8 ),
            new AddonInfo(0.1f, 6.3f, 0.1f, 18_000_000, 9_000, 4_500_000, 18000, 5.5f, 9 )
        )
    );
