...
public class ModMenuTypes {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<AcceleratorSpeedSensorMenu>> SPEED_SENSOR_MENU = registerMenuType(AcceleratorSpeedSensorMenu::new, "speed_sensor_menu");
