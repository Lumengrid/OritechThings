...
public class RenderBlockUtils {
    ...
    private static void createBox(PoseStack poseStack, BlockPos pos, Vec3 cameraPosition) {
        poseStack.pushPose();
        Minecraft mc = Minecraft.getInstance();
        createBox(mc.renderBuffers().bufferSource(), cameraPosition, poseStack, pos.getX(), pos.getY(), pos.getZ());
        poseStack.popPose();
    }
    ...
    private static void createBox(MultiBufferSource.BufferSource bufferSource, Vec3 cameraPosition, PoseStack poseStack, float x, float y, float z) {
        ...
        addLine(vertexConsumer, pose, x, y, z, x + offset, y, z, color);  // Bottom-front edge
        addLine(vertexConsumer, pose, x, y, z, x, y, z + offset, color);  // Bottom-left edge
        addLine(vertexConsumer, pose, x, y, z, x, y + offset, z, color);  // Bottom-left corner
        addLine(vertexConsumer, pose, x + offset, y, z, x + offset, y + offset, z, color);  // Bottom-right edge
        addLine(vertexConsumer, pose, x + offset, y, z, x + offset, y, z + offset, color);  // Bottom-right edge
        addLine(vertexConsumer, pose, x, y + offset, z, x, y + offset, z + offset, color);  // Bottom-left corner, top
        addLine(vertexConsumer, pose, x, y, z + offset, x + offset, y, z + offset, color);  // Bottom-back edge
        addLine(vertexConsumer, pose, x, y + offset, z, x + offset, y + offset, z, color);  // Top-left edge
        addLine(vertexConsumer, pose, x, y + offset, z, x, y + offset, z + offset, color);  // Top-front-left
        addLine(vertexConsumer, pose, x + offset, y + offset, z, x + offset, y + offset, z + offset, color);  // Top-right edge
